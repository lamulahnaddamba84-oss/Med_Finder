<div id="miniSidebar">
  <div class="brand-logo">
    <a class="d-none d-md-flex align-items-center gap-2" href="{{ route('admin.dashboard') }}">
      ...
      <span class="fw-bold fs-4  site-logo-text">Med Finder</span>
    </a>
  </div>
  <ul class="navbar-nav flex-column  ">
    ...
    <!-- Nav item -->
    <li class="nav-item">
      <a class="nav-link" href="{{ route('admin.dashboard') }}"><span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Otp Varification </a>
        </li>
      </ul>
    </li>
...
<div class="offcanvasNav offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
  ...
  <div class="offcanvas-body p-0">
    <ul class="navbar-nav flex-column  ">
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="#"><span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg"
              width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
              stroke-linecap="round" stroke-linejoin="round"
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Radialbar</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Polararea</a>
          </li>
        </ul>
      </li>
      <!-- Nav item -->
